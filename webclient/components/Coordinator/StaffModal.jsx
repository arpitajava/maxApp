                      ...
                      {allocationStatus.map((item, index) => {
                        return (
                          <Table.Row>
                            ...
                            <Table.Cell selectable textAlign='center'>{(item.Slot1.AppointmentID.length == 0)?'--':item.Slot1.AppointmentID}</Table.Cell>
                            <Table.Cell selectable textAlign='center'>{(item.Slot2.AppointmentID.length == 0)?'--':item.Slot2.AppointmentID}</Table.Cell>
                            <Table.Cell selectable textAlign='center'>{(item.Slot3.AppointmentID.length == 0)?'--':item.Slot3.AppointmentID}</Table.Cell>
                            <Table.Cell selectable textAlign='center'>{(item.Slot4.AppointmentID.length == 0)?'--':item.Slot4.AppointmentID}</Table.Cell>
                          </Table.Row>
                        )
                      })}
                    </Table.Body>
